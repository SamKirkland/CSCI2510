...
.L134:
	...
	rsb	r3, r5, r3, asl #3	@  num
	add	r1, r7, r3, asl #2
	ldr	r2, [r1, #36]	@  <variable>.activeFrame
	cmp	r2, #6
	moveq	r3, #7
	movne	r3, #6
...
.L311:
	ldr	ip, .L366+92
	ldr	r1, .L366+16
	ldr	r4, [ip, #0]	@  <variable>.x
	ldr	r6, [r1, #0]	@  x
	add	r3, r4, r6
	tst	r3, #15
	mov	r0, #32
	movne	r5, #0	@  isTileAligned
	moveq	r5, #1	@  isTileAligned
	bl	keyIsDown
	cmp	r0, #0
	bne	.L314
	mov	r0, #16
	...
	cmp	r0, #0
	bne	.L314
	cmp	r5, #0	@  isTileAligned
	bne	.L314
	ldr	r2, .L366+20
	ldr	r3, [r2, #0]	@  previousX
	rsb	r3, r6, r3
	rsb	r3, r4, r3	@  changeInX
	cmp	r3, #0	@  changeInX
	addgt	r3, r4, #1
	ldrgt	r4, .L366+92
...
.L314:
	...
	ldr	ip, .L366+28
	ldmia	r4, {r0-r1}	@  bg.playerVelocity
	mov	lr, pc
	bx	ip
	ldr	ip, .L366+96
	mov	r5, r1
...
.L324:
	...
	cmp	r2, #0
	ble	.L330
	ldr	r3, [sl, #32]	@  bg.deltaX
	sub	r2, r2, #1
	sub	r3, r3, #1
	str	r2, [r4, #0]	@  x
	str	r3, [sl, #32]	@  bg.deltaX
.L329:
	mov	r0, #16
	bl	keyIsDown
	cmp	r0, #0
...
.L333:
	...
	cmp	r1, r2, asl #3
	ldrlt	r3, [sl, #36]	@  bg.deltaY
	addlt	r2, r1, #1
	addlt	r3, r3, #1
	strlt	r2, [r9, #0]	@  y
	strlt	r3, [sl, #36]	@  bg.deltaY
.L337:
	ldr	r2, .L366+16
...
.L347:
	ldr	ip, .L366+92
	ldr	r1, .L366+16
	ldr	r2, [ip, #0]	@  <variable>.x
	ldr	r3, [r1, #0]	@  x
	add	r3, r3, r2
	ldr	r2, .L366+20
	str	r3, [r2, #0]	@  previousX
	ldmea	fp, {r4, r5, r6, r7, r8, r9, sl, fp, sp, lr}
	bx	lr
.L367:
	.align	2
...
.L334:
	ldr	r1, .L366+92
	ldr	r3, [r1, #0]	@  <variable>.x
	cmp	r3, #223
	addle	r3, r3, #1
	strle	r3, [r1, #0]	@  <variable>.x
	b	.L333
.L330:
	ldr	r5, .L366+92
	ldr	r3, [r5, #0]	@  <variable>.x
	cmp	r3, #0
	subgt	r3, r3, #1
	strgt	r3, [r5, #0]	@  <variable>.x
	b	.L329
.L364:
	ldr	r3, .L366+96
	stmia	r3, {r7-r8}	@  bg.playerVelocity
	b	.L321
.L320:
	adr	r4, .L366+100
	ldmia	r4, {r4-r5}
...
.L319:
	...
	ldmneia	r1, {r1-r2}
	ldrne	r3, .L366+96
	stmneia	r3, {r1-r2}	@  bg.playerVelocity
	bne	.L324
.L365:
	ldr	r2, .L366+88
	ldr	r4, .L366+96
	...
	mov	r5, r1
	mov	r4, r0
	stmia	ip, {r0-r1}	@  bg.playerVelocity
	ldr	r8, .L366+68
	...
	cmp	r0, #0
	ldrgt	r1, .L366+96
	stmgtia	r1, {r6-r7}	@  bg.playerVelocity
.L326:
	ldr	r4, .L366+96
	ldr	r0, [r9, #0]	@  y
	mov	lr, pc
	bx	r8
	ldr	r5, .L366+84
	ldmia	r4, {r2-r3}	@  bg.playerVelocity
	mov	lr, pc
	bx	r5
	ldr	r6, .L366+76
	mov	lr, pc
	...
	bx	r7
	ldr	r5, .L366+88
	str	r0, [r5, #36]	@  bg.deltaY
	b	.L324
.L363:
	ldrlt	r5, .L366+92
	sublt	r3, r4, #1
	strlt	r3, [r5, #0]	@  <variable>.x
	b	.L314
.L362:
	mov	r3, #16
	str	r3, [r9, #0]	@  y
	...
	adr	r3, .L366+100
	ldmia	r3, {r3-r4}
	stmia	r5, {r3-r4}	@  bg.playerVelocity
	b	.L311
